<footer class="w-full bg-primary mt-52">
            ...
            <div class="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
                ...
                <div class="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
                    ...
                    <ul class="text-gray-900 transition-all duration-500 grid gap-6">
                        <li>azka@gmail.com</li>
                        <li>0895324922467</li>
                        <li>jawa barat, bogor, ciawi</li>
                    </ul>
                </div>
                <div class="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
                    <h4 class="text-lg text-gray-900 font-bold mb-9 text-center xl:text-left">Relation</h4>
                    <div class="flex gap-6 xl:gap-12 max-xl:justify-center">
                        <ul class="text-gray-600 transition-all duration-500 grid gap-6">
                            <li><a href="javascript:;">smkamaliah.com</a></li>
                            <li><a href="javascript:;">amaliahpkl.com</a></li>
                            <li><a href="javascript:;">amaliahinvetaris.com</a></li>
                            <li><a href="javascript:;">lpsbankamaliah.com</a></li>
                        </ul>
                    </div>
                </div>
                <form class="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
                    <h4 class="text-lg text-gray-900 font-bold mb-9 text-center xl:text-left">kirim pesan atau bantuan ke admin</h4>
                    <div class="grid gap-1 ">
                        <input type="email" name="email"
                            class="py-2 px-4 border border-none shadow-sm h-14 text-lg bg-accent text-text rounded-t-xl w-full  xl:w-64 placeholder:text-paragraph focus:border-none focus:ring-black focus:outline-none"
                            placeholder="Enter email.." />
                        <textarea name="message" id="" class="py-2 px-4 border border-none shadow-sm bg-accent text-lg text-text w-full rounded-b-xl xl:w-64 placeholder:text-paragraph focus:border-none focus:ring-black focus:outline-none" placeholder="Enter message.."></textarea>
                        <button type="submit"
                            class="flex gap-2 mt-10 justify-center items-center py-1 px-5 rounded-full  bg-secondary shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-accent">kirim<i class="bi bi-arrow-right-circle-fill text-xl"></i>
                        </button>
                    </div>
                </form>
        ...
        <div class="py-4 bg-white">
            <div class="flex items-center justify-center">
                <span class="text-sm text-gray-800 ">Copyright@2024 All Right Reserved  by <a href="https://pagedone.io/">pagedone</a></span>
            </div>
        </div>
</footer>