...
@section('content')
    ...
    <form action="{{ route('detail-tagihan.update', $detail_tagihans->id_detail_tagihan) }}" method="POST">
        @csrf @method('PUT')
        ...
        <a href="{{ route('detail-tagihan.index') }}" class="ml-2 text-gray-600">Batal</a>
    </form>
@endsection
