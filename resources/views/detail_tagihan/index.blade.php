...
@section('admin-sidebar')
    ...
    <a href="{{ route('detail-tagihan.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Tambah Tarif Tagihan</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    <a href="{{ route('detail-tagihan.edit', $detail->id_detail_tagihan) }}" class="text-blue-500">Edit</a>
                    <form action="{{ route('detail-tagihan.destroy', $detail->id_detail_tagihan) }}" method="POST" class="inline">
                        @csrf @method('DELETE')
