        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex items-center space-x-2">
                    <!-- Export -->
                    <form action="{{ route('tahun-ajaran.export') }}" method="GET" class="inline">
                    ...
                    <!-- Tambah Data -->
                    <a href="{{ route('admin.tahun-ajaran.create') }}"   class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md text-sm font-medium btn-hover flex items-center">
                        Tambah Data
...
document.addEventListener('DOMContentLoaded', function() {  
    ...
    document.getElementById('apply-sort').addEventListener('click', function() {
        ...
        ['tahun_ajaran', 'status'].forEach(param => {
